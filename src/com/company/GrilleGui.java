...
public class GrilleGui implements Runnable {
    ...
    private Dimension dimensionEcan = 
     ...
     */
    public GrilleGui(Dimension dimensionGrille, 
    		Color couleurTexte, 
    		Color couleurFond, 
    		String[] options) {
        ...
        this.nbLignes = 
        		(int) (dimensionGrille.height / Constantes.DIMENSION_CASE_Y);
        
        this.nbColonnes = 
        		(int) (dimensionGrille.width / Constantes.DIMENSION_CASE_X);
    ...
    public void run() {
        ...
        if (tabMenus != null) {
            ...
            Dimension dimensionHaut =
            		new Dimension(dimensionEcan.width, 
            				(int) (dimensionEcan.height * .8));
            
            Dimension dimensionBas =
            		new Dimension(dimensionEcan.width, 
            				(int) (dimensionEcan.height * .1));

            // On fixe les dimensions des deux panneaux pour l'allure de
            // la fenêtre.
    ...
    private void ajouterMenu(JPanel panneau) {
        ...
        for (int i = 0; i < tabMenus.length; i++) {
            ...
            // On ajoute un listner pour détecter les clics dans le menu 
            // (au lieu de la grille).
            boutonCourant.addActionListener(new listenerBoutonMenu());
     ...
     * @version FBourdeau - A2017
     */
    private class listenerBoutonMenu implements ActionListener {
    ...
    private class MonJButton extends JButton {
        ...
        /**
         * Constructeur du bouton afin de spécifier sa position du bouton et 
         * sa valeur.
         * 
         * @param y
